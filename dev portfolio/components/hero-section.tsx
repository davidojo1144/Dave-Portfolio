...
export function HeroSection() {
  return (
    <section id="home" className="relative overflow-hidden border-b" aria-label="Hero">
      ...
      <div className="container max-w-6xl px-4 py-16 md:py-24 mx-auto grid lg:grid-cols-2 gap-10 items-center">
        <div>
          <motion.h1
          ...
          >
            ...
            From auth to cloud, I’ve touched Appwrite, Clerk, Firebase, Supabase, and Google Cloud.
          </motion.p>
          ...
          >
            ...
            <Button asChild variant="outline">
              <a href="/placeholder.svg?height=1&width=1" download>
                Download Résumé
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="relative aspect-square w-full max-w-md mx-auto rounded-2xl border bg-gradient-to-br from-background to-muted/60 p-2 shadow-sm">
